...
#curl https://www.mpich.org//static/downloads/3.2/mpich-3.2.tar.gz | tar xvz
...
./configure -prefix=`pwd`/.. --disable-fortran --enable-mpi MPICC=/opt/ibm/platform_mpi/bin/mpicc
make
make install
cd ..
